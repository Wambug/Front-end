    ...
    <div class="max-w-xs w-full  m-auto bg-indigo-100 rounded p-5">
        ...
        <form @submit.prevent="login">
            ...
            <div>
                ...
                <input v-model="Password" class="w-full p-2 mb-6 text-indigo-700 border-b-2 border-indigo-500 outline-none focus:bg-gray-300" type="password" name="password">
            </div>
            <div>     
        ...
        <footer>
            ...
            <router-link :to="{name:'Register'}" class="text-indigo-700 hover:text-pink-700 text-sm float-right" href="#">Create Account</router-link>
        </footer> 
    </div>
</template>
